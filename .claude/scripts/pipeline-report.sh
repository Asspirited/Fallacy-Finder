#!/usr/bin/env bash
# pipeline-report.sh — self-contained pipeline runner for Fallacy Finder / Veritas
# Contract: specs/pipeline-report.feature (to be written)
# Never call nvm externally — bootstrap is internal

export NVM_DIR="/home/rodent/.nvm"
\. "$NVM_DIR/nvm.sh"

cd /home/rodent/fallacy-finder
